...
import androidx.compose.ui.unit.dp
import app.sigot.core.ui.components.bottomsheet.SheetState.Companion.Saver
import app.sigot.core.ui.foundation.AnchoredDraggableState
import app.sigot.core.ui.foundation.animateTo
import app.sigot.core.ui.foundation.snapTo
...
public class SheetState(
     ...
     */
    public fun calculateSheetProgress(): Float {
        try {
