...
import now.shouldigooutside.core.ui.components.topbar.TopBarDefaults.TopBarHeight
import now.shouldigooutside.core.ui.components.topbar.TopBarState.Companion.Saver
...
public fun TopBar(
    ...
    title: (@Composable TopBarScope.() -> Unit)? = null,
    navigationIcon: (@Composable TopBarScope.() -> Unit)? = null,
    actions: (@Composable TopBarScope.() -> Unit)? = null,
    ...
    TopBarLayout(
        ...
        Row(
            ...
            val scope = TopBarScope(this)
            if (navigationIcon != null) {
                scope.navigationIcon()
            ...
            Row(
                ...
                if (title != null) {
                    ProvideTextStyle(AppTheme.typography.h1) {
                        scope.title()
                    }
                }
            }
...
@Preview(name = "Title Only - Light")
@Preview(name = "Title Only - Dark", uiMode = UI_MODE_NIGHT_YES or UI_MODE_TYPE_NORMAL)
@Composable
...
@Preview(name = "With Navigation Icon")
@Composable
private fun WithNavigationIconPreview() {
    AppPreview {
        TopBar(
            title = { Title("Settings") },
            navigationIcon = {
...
@Composable
private fun WithActionsPreview() {
    AppPreview {
        TopBar(
            title = { Title("Settings") },
            actions = {
...
@Preview(name = "Full - Light")
@Preview(name = "Full - Dark", uiMode = UI_MODE_NIGHT_YES or UI_MODE_TYPE_NORMAL)
@Composable
