package now.shouldigooutside.core.ui.navigation.bottomsheet
...
import now.shouldigooutside.core.ui.components.bottomsheet.SheetState
import now.shouldigooutside.core.ui.components.bottomsheet.SheetValue
import now.shouldigooutside.core.ui.components.bottomsheet.rememberModalBottomSheetState
import now.shouldigooutside.core.ui.navigation.BackHandler

public class BottomSheetNavigatorSheetState(
 ...
 * [Composable] by setting it directly on an instantiated [Destination].
 *
...
public class BottomSheetNavigator(
    ...
    public var sheetEnabled: Boolean by mutableStateOf(false)
        private set
