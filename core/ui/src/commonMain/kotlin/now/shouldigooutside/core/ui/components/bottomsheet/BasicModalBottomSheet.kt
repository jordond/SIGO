package now.shouldigooutside.core.ui.components.bottomsheet
...
import now.shouldigooutside.core.ui.components.BottomSheetDefaults
import now.shouldigooutside.core.ui.components.bottomsheet.SheetValue.Expanded
import now.shouldigooutside.core.ui.components.bottomsheet.SheetValue.Hidden
import now.shouldigooutside.core.ui.components.bottomsheet.SheetValue.PartiallyExpanded
import now.shouldigooutside.core.ui.components.brutalBorder
import now.shouldigooutside.core.ui.foundation.DraggableAnchors
import now.shouldigooutside.core.ui.foundation.draggableAnchors
import kotlin.math.max
import kotlin.math.min

@Composable
public fun BasicModalBottomSheet(
...
/** Default values for [now.shouldigooutside.core.ui.components.ModalBottomSheet] */
@Immutable
public expect object ModalBottomSheetDefaults {
    /** Properties used to customize the behavior of a [now.shouldigooutside.core.ui.components.ModalBottomSheet]. */
 ...
 */
internal fun Modifier.verticalScaleUp(state: SheetState) =
    graphicsLayer {
 ...
 * @see verticalScaleUp
 */
internal fun Modifier.verticalScaleDown(state: SheetState) =
    graphicsLayer {
        val offset = state.anchoredDraggableState.offset
        val anchor = state.anchoredDraggableState.anchors.minAnchor()
        val overflow = if (offset < anchor) anchor - offset else 0f
